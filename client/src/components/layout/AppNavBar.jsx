...
const AppNavBar = () => {
    const {byKeywordList,byKeywordListRequest}=productStore();
    return (
        <>
                    ...
                    <div className= " col-md-6 " >
                        <span>
                            ...
                            <span className= " f-12 mx-2 " >
                                <i className= "bi bi-envelope" >01820047243</i>
                            </span>
                        </span>
                    </div>
                    <div className=" col-md-6 " >
                    ...
                    <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
                        ...
                        <div className=" d-lg-flex">
                            <div className="input-group">
                                <input  onChange={(e)=>byKeywordListRequest(e.target.value)} className="form-control" type="search" placeholder="Search" aria-label="Search" />
                                <Link to={byKeywordList.length>0?`/by-keyword/${byKeywordList}`:`/`} className="btn btn-outline-dark" type="submit">
